...
import com.techgeeknext.config.saml.AppConfig;
import com.techgeeknext.config.saml.BeanConfig;
...
public class WebSecurityConfig extends SamlIdentityProviderSecurityConfiguration {

    private final AppConfig appConfig;
    private final BeanConfig beanConfig;


    public WebSecurityConfig(BeanConfig beanConfig, @Qualifier("appConfig") AppConfig appConfig) {
